...
function removeFirstOccurrences(str, value) {
  ...
  const firstHalfString = str.slice(0, str.indexOf(value));
  const secondHalfString = str.slice(str.indexOf(value) + value.length);
...
function removeLastOccurrences(str, value) {
  ...
  const firstHalfString = str.slice(0, str.lastIndexOf(value));
  const secondHalfString = str.slice(str.lastIndexOf(value) + value.length);
  return firstHalfString + secondHalfString;
}
